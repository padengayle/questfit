...
class Exercise(BaseModel):
    ...
    sets: List[ExerciseSet] = Field(default_factory=list, description="List of sets completed for this exercise")
    rounds: Optional[float] = Field(None, description="Number of rounds completed if this is a circuit or AMRAP")
    
# The final strict output the Vision/Text Extractor MUST return
